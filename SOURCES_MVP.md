...
- Прокси нужен для:
  - R16, R20 - телеграм в РФ заблокирован
  - UA3 - СПЖ в РФ заблокирован

- `parser: "telegram"` для: R16, R20

- Фильтры RSS нужны для:
  - R14 - `<category>Новости Казанской епархии</category>`
  - R26 - `<category>Новости</category>`

- R18 - RSS сгенерирован с сайта
